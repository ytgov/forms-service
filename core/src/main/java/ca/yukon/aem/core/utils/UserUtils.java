...
public class UserUtils {
    ...
    public static final String RC_ID = "profile/rcid";
    ...
    public static String findRcId(Authorizable user) throws RepositoryException {
        String rcId = "";
        if (user.hasProperty(RC_ID)) {
            rcId = user.getProperty(RC_ID)[0].getString();
        }
        return rcId;
    }
}